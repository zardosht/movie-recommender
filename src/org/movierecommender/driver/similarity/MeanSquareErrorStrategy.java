...
public class MeanSquareErrorStrategy implements SimilarityStrategy {

	
	private final UserItemMatrix matrix;

	public MeanSquareErrorStrategy(UserItemMatrix matrix){
		this.matrix = matrix;
	}
	
	@Override
	public SimilarityResult calculateSimilarty(User u1, User u2) {
		//TODO: schick email regarding formula an seite 15. Was bedeuted ein vektor zum quadrat? 
		double value = 0;
