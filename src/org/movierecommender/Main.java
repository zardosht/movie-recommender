...
import org.movierecommender.driver.similarity.MeanSquareErrorStrategy;
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.setRatingPredictor(new MeanPredictor()).setSimilarityStrategy(new MeanSquareErrorStrategy(matrix));
